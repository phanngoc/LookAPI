...
import { Zap, Database, Layers, ArrowRight, Code2 } from 'lucide-react';
      ...
      <div className="max-w-3xl w-full">
        ...
        <div className="mt-10 text-center">
          <p className="text-sm text-slate-400">
            ...
            <kbd className="px-1.5 py-0.5 bg-slate-100 rounded text-xs mx-1">⌘ Enter</kbd>
            to quickly send requests
          </p>
        </div>
      </div>
    </div>
